...
import com.qin.catcat.unite.common.utils.*;
import com.qin.catcat.unite.manage.CatManage;
import com.qin.catcat.unite.mapper.*;
...
import com.qin.catcat.unite.popo.entity.*;
import com.qin.catcat.unite.popo.vo.*;
...
//                + catDTO.getAvatar().substring(catDTO.getAvatar().lastIndexOf("."));
        ...
        fileNameConvertMap.put(catDTO.getAvatar(), objectName);
